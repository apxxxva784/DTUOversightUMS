...
class AddTeacher implements ActionListener{
	...
	lab.setFont(new Font("serif",Font.BOLD,20));
        ...
        String course[] = {"Professor","Assistant Professor","Associate Professor"};
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        String branch[] = {"COE", "IT", "SE", "MC", "EE", "ECE", "ME", "CE", "BT","PIE", "EEE", "MAM", "EP", "ENE", "Chemical", "Others"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into teacher values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+j+"','"+l+"','"+m+"','"+k+"')";
