...
public class StudentFeeForm extends JFrame implements ActionListener{
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] {"COE", "IT", "SE", "MC", "EE", "ECE", "ME", "CE", "BT","PIE", "EEE", "MAM", "EP", "ENE", "PCT", "Others"}));
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] { "B.Tech (FT)", "B.Tech (LE)", "B.Tech (Evening)", "B.Des", "BBA", "M.Tech (FT)", "MBA" }));
