...
class UpdateStudent implements ActionListener{
    ...
    UpdateStudent(){;
        ...
        id8.setFont(new Font("Arial",Font.PLAIN,40));
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        id16= new JLabel("Jee Mains Rank");
        id16.setBounds(400,470,150,30);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update student set name='"+t1.getText()+"',fathers_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',class_x='"+t8.getText()+"',class_xii='"+t9.getText()+"',aadhar='"+t10.getText()+"',course='"+t13.getText()+"',jee_rank='"+t15.getText()+"',branch='"+t14.getText()+"' where rollno='"+t12.getText()+"'";
